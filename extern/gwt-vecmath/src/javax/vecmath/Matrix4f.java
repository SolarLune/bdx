...
public class Matrix4f implements java.io.Serializable, Cloneable {
	 ...
	 * components of the matrix (upper 3x3) and not to the translational
	 ...
	 * parameter "matrix2" is a set of column vectors assembled into a 4x4 matrix
	...
	static void luBacksubstitution(double[] matrix1, int[] row_perm,
		...
		for (k = 0; k < 4; k++) {
			...
			matrix2[cv + 4 * 0] = (matrix2[cv + 4 * 0] - matrix1[rv + 1]
					* matrix2[cv + 4 * 1] - matrix1[rv + 2] * matrix2[cv + 4 * 2] - matrix1[rv + 3]
					* matrix2[cv + 4 * 3])
					/ matrix1[rv + 0];
		}
	}
	...
	public final void mul(Matrix4f m1) {
		...
		m00 = this.m00 * m1.m00 + this.m01 * m1.m10 + this.m02 * m1.m20 + this.m03
				* m1.m30;
		m01 = this.m00 * m1.m01 + this.m01 * m1.m11 + this.m02 * m1.m21 + this.m03
				* m1.m31;
		m02 = this.m00 * m1.m02 + this.m01 * m1.m12 + this.m02 * m1.m22 + this.m03
				* m1.m32;
		m03 = this.m00 * m1.m03 + this.m01 * m1.m13 + this.m02 * m1.m23 + this.m03
				* m1.m33;

		m10 = this.m10 * m1.m00 + this.m11 * m1.m10 + this.m12 * m1.m20 + this.m13
				* m1.m30;
		m11 = this.m10 * m1.m01 + this.m11 * m1.m11 + this.m12 * m1.m21 + this.m13
				* m1.m31;
		m12 = this.m10 * m1.m02 + this.m11 * m1.m12 + this.m12 * m1.m22 + this.m13
				* m1.m32;
		m13 = this.m10 * m1.m03 + this.m11 * m1.m13 + this.m12 * m1.m23 + this.m13
				* m1.m33;

		m20 = this.m20 * m1.m00 + this.m21 * m1.m10 + this.m22 * m1.m20 + this.m23
				* m1.m30;
		m21 = this.m20 * m1.m01 + this.m21 * m1.m11 + this.m22 * m1.m21 + this.m23
				* m1.m31;
		m22 = this.m20 * m1.m02 + this.m21 * m1.m12 + this.m22 * m1.m22 + this.m23
				* m1.m32;
		m23 = this.m20 * m1.m03 + this.m21 * m1.m13 + this.m22 * m1.m23 + this.m23
				* m1.m33;

		m30 = this.m30 * m1.m00 + this.m31 * m1.m10 + this.m32 * m1.m20 + this.m33
				* m1.m30;
		m31 = this.m30 * m1.m01 + this.m31 * m1.m11 + this.m32 * m1.m21 + this.m33
				* m1.m31;
		m32 = this.m30 * m1.m02 + this.m31 * m1.m12 + this.m32 * m1.m22 + this.m33
				* m1.m32;
		m33 = this.m30 * m1.m03 + this.m31 * m1.m13 + this.m32 * m1.m23 + this.m33
				* m1.m33;
	...
	public final void mul(Matrix4f m1, Matrix4f m2) {
		if (this != m1 && this != m2) {
			...
			this.m00 = m1.m00 * m2.m00 + m1.m01 * m2.m10 + m1.m02 * m2.m20 + m1.m03
					* m2.m30;
			this.m01 = m1.m00 * m2.m01 + m1.m01 * m2.m11 + m1.m02 * m2.m21 + m1.m03
					* m2.m31;
			this.m02 = m1.m00 * m2.m02 + m1.m01 * m2.m12 + m1.m02 * m2.m22 + m1.m03
					* m2.m32;
			this.m03 = m1.m00 * m2.m03 + m1.m01 * m2.m13 + m1.m02 * m2.m23 + m1.m03
					* m2.m33;

			this.m10 = m1.m10 * m2.m00 + m1.m11 * m2.m10 + m1.m12 * m2.m20 + m1.m13
					* m2.m30;
			this.m11 = m1.m10 * m2.m01 + m1.m11 * m2.m11 + m1.m12 * m2.m21 + m1.m13
					* m2.m31;
			this.m12 = m1.m10 * m2.m02 + m1.m11 * m2.m12 + m1.m12 * m2.m22 + m1.m13
					* m2.m32;
			this.m13 = m1.m10 * m2.m03 + m1.m11 * m2.m13 + m1.m12 * m2.m23 + m1.m13
					* m2.m33;

			this.m20 = m1.m20 * m2.m00 + m1.m21 * m2.m10 + m1.m22 * m2.m20 + m1.m23
					* m2.m30;
			this.m21 = m1.m20 * m2.m01 + m1.m21 * m2.m11 + m1.m22 * m2.m21 + m1.m23
					* m2.m31;
			this.m22 = m1.m20 * m2.m02 + m1.m21 * m2.m12 + m1.m22 * m2.m22 + m1.m23
					* m2.m32;
			this.m23 = m1.m20 * m2.m03 + m1.m21 * m2.m13 + m1.m22 * m2.m23 + m1.m23
					* m2.m33;

			this.m30 = m1.m30 * m2.m00 + m1.m31 * m2.m10 + m1.m32 * m2.m20 + m1.m33
					* m2.m30;
			this.m31 = m1.m30 * m2.m01 + m1.m31 * m2.m11 + m1.m32 * m2.m21 + m1.m33
					* m2.m31;
			this.m32 = m1.m30 * m2.m02 + m1.m31 * m2.m12 + m1.m32 * m2.m22 + m1.m33
					* m2.m32;
			this.m33 = m1.m30 * m2.m03 + m1.m31 * m2.m13 + m1.m32 * m2.m23 + m1.m33
					* m2.m33;
		} else {
			float m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33; // vars
																																														// for
	 ...
	 * this object's upper 3x3 matrix to factor out the scale, then this object's
	 * upper 3x3 matrix components are replaced by the passed rotation components,
	...
	public final void get(Vector3f sca, Matrix4f transNoScale){
		Matrix3f oriScaled = new Matrix3f();
		getRotationScale(oriScaled);
		Matrix3f ori = new Matrix3f();
		oriScaled.get(sca, ori);
		transNoScale.set(this);
		transNoScale.orientation(ori);
	}
	...
	public final void scale(Vector3f v){
		...
		float n;
		n = (float) (v.x < 0 ? Math.min(v.x, -MIN_VALUE) : Math.max(v.x, MIN_VALUE)) / sca.x;
		m00 *= n; m01 *= n; m02 *= n;
		n = (float) (v.y < 0 ? (float) Math.min(v.y, -MIN_VALUE) : Math.max(v.y, MIN_VALUE)) / sca.y;
		m10 *= n; m11 *= n; m12 *= n;
		n = (float) (v.z < 0 ? (float) Math.min(v.z, -MIN_VALUE) : Math.max(v.z, MIN_VALUE)) / sca.z;
		m20 *= n; m21 *= n; m22 *= n;
	}
	...
	public final void orientation(Matrix3f m){
		Vector3f sca = scale();
		m00 = m.m00 * sca.x; m01 = m.m01 * sca.x; m02 = m.m02 * sca.x;
		m10 = m.m10 * sca.y; m11 = m.m11 * sca.y; m12 = m.m12 * sca.y;
	...
	public final static Matrix4f transform(Vector3f pos, Vector3f sca, Matrix3f ori){
		Matrix4f m = new Matrix4f();
		m.m00 = ori.m00 * sca.x; m.m01 = ori.m01 * sca.x; m.m02 = ori.m02 * sca.x; m.m03 = pos.x;
		m.m10 = ori.m10 * sca.y; m.m11 = ori.m11 * sca.y; m.m12 = ori.m12 * sca.y; m.m13 = pos.y;
		m.m20 = ori.m20 * sca.z; m.m21 = ori.m21 * sca.z; m.m22 = ori.m22 * sca.z; m.m23 = pos.z;
		m.m33 = 1;
		return m;
	}
